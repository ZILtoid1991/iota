...
public abstract class InputDevice {
	...
	public property InputDeviceType type() @nogc @safe pure nothrow const {
		return _type;
	}
	public property ubyte devNum() @nogc @safe pure nothrow const {
		return _devNum;
	}
}
public struct ButtonEvent {
	ubyte		dir;	///Up or down
	ubyte		aux;	///Used to identify modifier keys on keyboard
	ushort		id;		///Button ID
}
/**
