...
public enum GameControllerButtons : ubyte {
	...
	///XB: Back, PS: Select (formerly)/ Create, N: Select
	LeftNav,
...
/**
 * Contains symbol codes to be used to identify game controller input capabilities.
 */
...
/**
 * Contains information about a game controller's layout, in a struct-of-arrays layout.
 */
public struct GameControllerLayoutData {
	char[4] oemID;		///OEM ID if present, null otherwise
	ubyte[] type;		///Types of capabilities (axis, button, etc.)
	ubyte[] inputID;	///The code  generated by the capability
	uint[] symbolID;	///Symbol ID, may be a valid UTF-32 code, or code for some other symbol from an enumerator.
}
/**
